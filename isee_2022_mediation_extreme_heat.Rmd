...
Here we are showing the regression-based product method of mediation analysis with an example of simulated time-series data on extreme weather events using summer day data from 1996 to 2015 in one city. The relationship among all variables are shown in the DAG below.  
